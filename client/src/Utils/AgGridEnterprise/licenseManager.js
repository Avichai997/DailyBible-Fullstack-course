...
var LicenseManager = /** @class */ (function () {
  ...
  LicenseManager.prototype.validateLicense = function () {
    if (missingOrEmpty(LicenseManager.licenseKey)) {
      ...
      if (LicenseManager.licenseKey.indexOf('For_Trialing_ag-Grid_Only') !== -1) {
        ...
        var _a = LicenseManager.extractLicenseComponents(LicenseManager.licenseKey),
          md5 = _a.md5,
          license = _a.license,
          version = _a.version,
          isTrial = _a.isTrial;
  ...
  LicenseManager.extractLicenseComponents = function (licenseKey) {
    ...
    var _a = __read(LicenseManager.extractBracketedInformation(cleanedLicenseKey), 2),
      version = _a[0],
      isTrial = _a[1];
  ...
  LicenseManager.prototype.getLicenseDetails = function (licenseKey) {
    var _a = LicenseManager.extractLicenseComponents(licenseKey),
      md5 = _a.md5,
      license = _a.license,
      version = _a.version,
      isTrial = _a.isTrial;
    var valid =
      md5 === this.md5.md5(license) && licenseKey.indexOf('For_Trialing_ag-Grid_Only') === -1;
  ...
  LicenseManager.prototype.outputIncompatibleVersion = function (
    formattedExpiryDate,
